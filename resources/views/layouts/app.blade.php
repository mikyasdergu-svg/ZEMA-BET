...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>@yield('title', config('app.name', 'ዜማ ቤት'))</title>
    ...
    <body class="font-sans antialiased font-['Noto_Sans_Ethiopic']">
        <div class="min-h-screen bg-amber-50">
            @include('layouts.navigation')

            <!-- Page Heading -->
            @isset($header)
                <header class="bg-amber-100/80 backdrop-blur-md shadow-lg border-b border-amber-200">
